...
const DEFAULT_SETTINGS = {
  formats: [
    ...
    { id: "tiff", label: "TIFF", visible: true, topLevel: true  },
  ...
  batchFilter: { minWidth: 100, maxWidth: 0, preferHighRes: true },
...
async function loadSettings() {
  ...
  if (s.batchFilter) Object.assign(settings.batchFilter, s.batchFilter);
